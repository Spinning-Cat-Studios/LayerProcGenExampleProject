...
public partial class Terrain3DData : GodotObject
{
    ...
    public new static class GDExtensionMethodName
    {
        ...
        public new static readonly StringName ForceUpdateMaps = "force_update_maps";
    ...
    public new void SaveRegion(Vector2I directory, string regionLocation, bool arg16Bit = false) => 
        Call(GDExtensionMethodName.SaveRegion, [directory, regionLocation, arg16Bit]);

    public new void LoadDirectory(string directory) => 
        Call(GDExtensionMethodName.LoadDirectory, [directory]);

    public new void LoadRegion(Vector2I directory, string regionLocation, bool update = true) => 
        Call(GDExtensionMethodName.LoadRegion, [directory, regionLocation, update]);
    ...
    public new void ForceUpdateMaps(Terrain3DRegion.MapType mapType = Terrain3DRegion.MapType.Max, bool generateMipmaps = false) => 
        Call(GDExtensionMethodName.ForceUpdateMaps, [Variant.From(mapType), generateMipmaps]);
    ...
    public new bool IsInSlope(Vector3 globalPosition, Vector2 slopeRange, bool invert = false) => 
        Call(GDExtensionMethodName.IsInSlope, [globalPosition, slopeRange, invert]).As<bool>();
