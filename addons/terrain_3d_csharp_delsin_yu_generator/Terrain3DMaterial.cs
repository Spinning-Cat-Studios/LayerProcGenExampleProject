...
public partial class Terrain3DMaterial : Resource
{
    ...
    public new static class GDExtensionPropertyName
    {
        ...
        public new static readonly StringName AutoShader = "auto_shader";
        public new static readonly StringName DualScaling = "dual_scaling";
    ...
    public new bool AutoShader
    {
        get => Get(GDExtensionPropertyName.AutoShader).As<bool>();
        set => Set(GDExtensionPropertyName.AutoShader, value);
    }

    public new bool DualScaling
    {
        get => Get(GDExtensionPropertyName.DualScaling).As<bool>();
        set => Set(GDExtensionPropertyName.DualScaling, value);
    }
