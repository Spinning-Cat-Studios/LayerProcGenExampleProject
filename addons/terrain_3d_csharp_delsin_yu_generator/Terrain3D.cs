...
public partial class Terrain3D : Node3D
{
    ...
    public new static class GDExtensionPropertyName
    {
        ...
        public new static readonly StringName CollisionEnabled = "collision_enabled";
        ...
        public new static readonly StringName Storage = "storage";
    }
    ...
    public new bool CollisionEnabled
    {
        get => Get(GDExtensionPropertyName.CollisionEnabled).As<bool>();
        set => Set(GDExtensionPropertyName.CollisionEnabled, value);
    }
    ...
    public new Terrain3DTextureList TextureList
    {
        get => Get(GDExtensionPropertyName.TextureList).As<Terrain3DTextureList>();
        set => Set(GDExtensionPropertyName.TextureList, value);
    }

    public new Terrain3DStorage Storage
    {
        get => Get(GDExtensionPropertyName.Storage).As<Terrain3DStorage>();
        set => Set(GDExtensionPropertyName.Storage, value);
    }
    ...
    public new static class GDExtensionMethodName
    {
        ...
        public new static readonly StringName GetCollisionRid = "get_collision_rid";
        public new static readonly StringName IsCompatibilityMode = "is_compatibility_mode";
        ...
        public new static readonly StringName SplitStorage = "split_storage";
    }
    ...
    public new Rid GetCollisionRid() => 
        Call(GDExtensionMethodName.GetCollisionRid, []).As<Rid>();

    public new bool IsCompatibilityMode() => 
        Call(GDExtensionMethodName.IsCompatibilityMode, []).As<bool>();

    public new Vector3 GetIntersection(Vector3 srcPos, Vector3 direction) => 
        Call(GDExtensionMethodName.GetIntersection, [srcPos, direction]).As<Vector3>();

    public new Mesh BakeMesh(long lod, Terrain3DData.HeightFilter filter) => 
    ...
    public new void SplitStorage() => 
        Call(GDExtensionMethodName.SplitStorage, []);
