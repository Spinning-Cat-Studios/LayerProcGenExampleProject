...
public partial class Terrain3DInstancer : GodotObject
{
    ...
    public new static class GDExtensionMethodName
    {
        ...
        public new static readonly StringName ForceUpdateMmis = "force_update_mmis";
        public new static readonly StringName SwapIds = "swap_ids";
        public new static readonly StringName DumpData = "dump_data";
    ...
    public new void ForceUpdateMmis() => 
        Call(GDExtensionMethodName.ForceUpdateMmis, []);

    public new void SwapIds(long srcId, long destId) => 
        Call(GDExtensionMethodName.SwapIds, [srcId, destId]);

    public new void DumpData() => 
        Call(GDExtensionMethodName.DumpData, []);
