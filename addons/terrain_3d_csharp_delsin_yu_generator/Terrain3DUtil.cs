...
public partial class Terrain3DUtil : GodotObject
{
    ...
    public new static Image PackImage(Image srcRgb, Image srcA, bool invertGreen = false, bool invertAlpha = false, long alphaChannel = 0) => 
        ClassDB.ClassCallStatic(NativeName, GDExtensionMethodName.PackImage, [srcRgb, srcA, invertGreen, invertAlpha, alphaChannel]).As<Image>();

    public new static Image LuminanceToHeight(Image srcRgb = null) => 
