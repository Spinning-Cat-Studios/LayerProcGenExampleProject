...
public partial class Terrain3DTextureAsset : Resource
{
    ...
    public new static class GDExtensionPropertyName
    {
        ...
        public new static readonly StringName Detiling = "detiling";
    }
    ...
    public new double Detiling
    {
        get => Get(GDExtensionPropertyName.Detiling).As<double>();
        set => Set(GDExtensionPropertyName.Detiling, value);
    }
